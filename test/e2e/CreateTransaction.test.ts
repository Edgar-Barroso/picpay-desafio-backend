...
beforeAll(async ()=>{
    ...
    user1 = new CommonClient("Jose Edgar Barroso Neto","629.925.773-32","joseedgar1@test.com","123456",1000)
    user2 = new Storekeeper("Jose Edgar Barroso Neto","774.994.860-01","joseedgar2@test.com","123456",1000)
